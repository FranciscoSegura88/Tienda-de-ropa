...
<div class="flex w-full overflow-hidden p-4 items-center justify-center">
  <video class="w-1/2 h-auto" loop autoplay muted controlsList="nodownload nofullscreen" disablePictureInPicture>
    ...
    <div class="flex flex-wrap justify-center gap-6 p-6">
        ...
        <div class="card trend bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
        ...
        <div class="card ninos accesorios bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <div class="card ninos ropa bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <div class="card tenis mujer bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <div class="card ninos tenis bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <div class="card hombre accesorio bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <!-- Ropa hombre -->
        <div class="card hombre ropa bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <!-- Tenis mujer -->
        <div class="card mujer tenis bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
            <h3 class="text-lg font-semibold mt-2">Tenis mujer 1</h3>
            <p class="text-sm text-gray-600">Descripción del producto 1.</p>
            <button class="bg-gray-800 text-white px-4 py-2 rounded-lg mt-4 hover:bg-gray-700">Comprar</button>
        ...
        <!-- Tenis Hombre -->
        <div class="card hombre tenis bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <!-- Accesorios mujer -->
        <div class="card mujer accesorio bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
            <img src="producto1.jpg" alt="Producto 1" class="w-full rounded-lg">
        ...
        <!-- Ropa mujer -->
        <div class="card mujer ropa bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:animate-bounce hover:border-red-500">
