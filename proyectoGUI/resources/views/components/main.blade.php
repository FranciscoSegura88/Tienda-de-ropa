...
<div class="flex flex-wrap justify-center gap-6 p-6">
    @foreach($productos as $producto)
        <div class="card
            ...
            bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48 hover:scale-115 transition-transform duration-300 ease-in-out hover:border-red-500"
