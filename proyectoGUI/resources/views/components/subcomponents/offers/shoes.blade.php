...
@section('mainContent')
    ...
    <div class="flex flex-wrap justify-center gap-6 p-6">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48">
            ...
            <h3 class="text-lg font-semibold mt-2">Tenis oferta 1</h3>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48">
            ...
            <h3 class="text-lg font-semibold mt-2">Tenis oferta 2</h3>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4 text-center w-48">
            ...
            <h3 class="text-lg font-semibold mt-2">Tenis oferta 3</h3>
